import freshLib as f
import threading

while(True):
    print("1.Press 1 to create new key-value pair.\n2.Press 2 to read a value. \n3.Press 3 to Delete a key-value. \n4.Enter any number(other than 1,2,3) to exit.")
    val = int(input())
    if(val==1):
        print("Enter key:")
        key = input()
